    ...
    return Dismissible(
      ...
      onDismissed: (direction) {
                ...
                ScaffoldMessenger.of(context)
                    .showSnackBar(SnackBar(content: Text("${widget.royxatlar.name} o'chirildi")));
              },
      ...
      child: ListTile(
        ...
        title: Text(widget.royxatlar.name , style: TextStyle(fontSize: 16, fontWeight:FontWeight.bold),),
        subtitle: Text("${DateFormat("d-MMMM-yyyy").format(widget.royxatlar.day)}", style: TextStyle(fontSize: 12),),
